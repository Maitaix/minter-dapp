const contractAddress = '0x75CBa701Cb1EcFDa55A9E3227B1dD57624120c28'; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = 'Welcome to the MaxTest NFT Project!!';
const welcome_h2 = 'Connect to MetaMask to Get Started';
const welcome_p =
    'The MaxTest NFT Project is a decentralized, open-source project that aims to demonstrate how to develope and launch your own NFT Collection. Follow step by step on the <a href="https://youtube.com/codestackr"  target="_blank" rel="noopener noreferrer">codeSTACKr</a> YouTube channel.';
